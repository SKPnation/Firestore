...
public class AddPostActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //enable back button n actionbar
        ...
        userDbRef = FirebaseFirestore.getInstance().collection("Users");
        DocumentReference docRef = userDbRef.document(user.getUid());
            ...
            case CAMERA_REQUEST_CODE:{
                if (grantResults.length > 0){
                    ...
                    if (cameraAccepted && writeStorageAccepted){
                        ...
                        Toast.makeText(AddPostActivity.this, "Camera & Storage permissions are necessary...", Toast.LENGTH_SHORT).show();
                    }
                }
            }
            break;
            case STORAGE_REQUEST_CODE:{
                if (grantResults.length > 0){
                    ...
                    if (writeStorageAccepted){
                        ...
                        Toast.makeText(AddPostActivity.this, "Storage permissions are necessary...", Toast.LENGTH_SHORT).show();
                    }
                }
            }
            break;
